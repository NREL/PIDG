...
if (india.repo){
    ...
    scenario.SR.properties[, child_object := region.zone[Zone != "SR", Region]]
    ...
    # -------------------------------------------------------------------------|
    #scenario to objects
    scenario.WR.to.objects <- initialize_table(Objects.sheet, 
                                               1, 
                                               list(class = "Scenario", 
                                                    name = "Aggregate non-WR", 
